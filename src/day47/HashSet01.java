...
public class HashSet01 {
  ...
  /*
Set : 
1) unique(benzersiz tek) elemanlardan olusur, Set'lerin icinde bir eleman sadece bir kere kullanilabilir. mükerrer(duplicate) eleman olmaz.
...
.size();-->set’in eleman sayisini verir
  ...
  public static void main(String[] args) {
    ...
    HashSet<String> hs2 = new HashSet<>(
      Arrays.asList("başarılı", "azimli", "nasipli", "heyecanlı")
    );
    hs1.addAll(hs2);
    System.out.println(hs1);

    hs1.remove("başarılı");
    hs1.remove("heyecanlı");
    System.out.println(hs1);
