...
public class EpmDriver {
    public static void main(String[] args) {
        /* TODO:  Employee isminde bir class oluşturun. Alacağı değerler isim, maaş, çalışma saati ve işe başladığı yıl olacak.
        ...
        Employee calisan1=Employee.calisanBilgi("Mehmet",2500,45,2015);
        Employee calisan2=Employee.calisanBilgi("Ahmet",2000,40,2010);
        Employee.bilgiYaz(calisan1);
