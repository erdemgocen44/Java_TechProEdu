...
public class C02_forEachLoops {
    public static void main(String[] args) {
        /*
         * Input olarak verilen 2 listeyi Parametre olarak kabul edip, ortak isimleri
         * yazdiran bir method yaziniz INPUT : list1={Ali,Veli,Ayse,Fatma,Omer}
