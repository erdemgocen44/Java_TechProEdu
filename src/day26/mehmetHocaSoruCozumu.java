...
public class mehmetHocaSoruCozumu {
    ...
    while (!cikilsinMi) {
      ...
      switch (islem) {
        ...
        case "5":
          ...
          break;
        case "6":
          System.out.println("Cıkis yapiliyor");
          cikilsinMi = true;
          break;
        default:
  ...
  private static void guncelle() {
    listele();
    System.out.println(
      "Yukaridaki listeden güncelleme istediginiz elemanin numarasini giriniz"
    );
  ...
  private static void sil() {
    listele();
    System.out.println(
      "Yukaridaki listeden silmek istediginiz elemanin numarasini giriniz"
    );
    int siraNo = scan.nextInt(); //\n
