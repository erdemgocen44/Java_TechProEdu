...
public class Market {
  ...
  public static void main(String[] args) {
    ...
    fiyatlar.addAll(
      Arrays.asList(2.1, 3.2, 1.5, 2.3, 3.1, 1.2, 1.9, 6.1, 4.3, 2.7, 0.5)
    );
    int urunNo;
    double kg = 0;
    String devam;
  ...
  public static void odemeYap(double toplam) {
    ...
    do {
      ...
      if (miktar < toplam) {
        ...
        System.out.println("ekleme yapacağınız miktar= " + (toplam - miktar));
      }
    } while (miktar <toplam);
    System.out.println("----------------------------------------------------");
    System.out.println("şu ana kadar" + miktar + " kadar odeme yaptınız");
