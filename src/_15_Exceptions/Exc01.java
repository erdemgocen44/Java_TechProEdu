...
fakat her kırmızı çizgi exceptions değildir. "Compile Time Exception" larda ya "throws" veya "try-catch" kullanimali handle edilmeli yoksa
		 	    code calismaz.

2-Run Time (unchecked) Exceptions :
Kod çalıştırıldığında ortaya çıkan exceptions’lardır."Run Time Exception" larda "throws", "try-catch", veya hicbiri kullanilmayabilir handle edilmeyebilir..



3) Code creat edilirken Excaption kullanmak zorunda kalinirsa :
...
5) try-catch bolgunda  try body  kod hatasiz calisirsa catch body calismaz. catch body try body deki
    exception da calisir..
