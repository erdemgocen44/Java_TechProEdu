package _JavaStudy._99_JavaProjects.LaptopPoject;
...
public class PriceForOneLaptop {
    ...
    public int getPrice(int laptopID) {
        ...
        int totalAmount = Calculation.getRam(arrayList) + Calculation.getColor(arrayList) + Calculation.getCPU(arrayList) +
